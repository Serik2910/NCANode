...
public class CmsController {
    ...
    @PostMapping("/signEsedo")
    public ResponseEntity<CmsResponse> signESEDO(@Valid @RequestBody CmsCreateRequestESEDO cmsCreateRequestESEDO) {
        return ResponseEntity.ok(cmsService.create(cmsCreateRequestESEDO));
    }
