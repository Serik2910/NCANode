...
public class Util {
    ...
    public static String getDigestAlgorithmOidBYSignAlgorithmOidESEDO(String signOid) {
        if (signOid.equals(PKCSObjectIdentifiers.sha1WithRSAEncryption.getId())) {
            return CMSSignedDataGenerator.DIGEST_SHA1;
        }
        else if (signOid.equals(PKCSObjectIdentifiers.sha256WithRSAEncryption.getId())) {
        ...
        else if (signOid.equals(KNCAObjectIdentifiers.gost3411_2015_with_gost3410_2015_256.getId())) { // GOST2015-256
            return CMSSignedDataGenerator.DIGEST_GOST3411_2015_256;
        }
        else if (signOid.equals(KNCAObjectIdentifiers.gost3411_2015_with_gost3410_2015_512.getId())) { // GOST2015-512
            return CMSSignedDataGenerator.DIGEST_GOST3411_2015_512;
        }
        else if (signOid.equals(CryptoProObjectIdentifiers.gostR3411_94_with_gostR34310_2004.getId())) {
            return CMSSignedDataGenerator.DIGEST_GOST3411_GT;
        } else {
            return CMSSignedDataGenerator.DIGEST_GOST34311_95;
        }
    }
